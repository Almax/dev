...
type Event = Object;
/**
 * Use `CustomPicker` to render a date/time picker (selector) on iOS.  This is
...
var styles = StyleSheet.create({
  datePickerIOS: {
    ...
    width: RCTDatePickerIOSConsts.ComponentWidth - 40,
  },
});

var RCTDatePickerIOS = requireNativeComponent('RCTDatePicker', CustomPicker, {
